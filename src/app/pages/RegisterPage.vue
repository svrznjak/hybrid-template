  ...
  <f7-page name="register">
    ...
    <Form @submit="doRegister()">
      <f7-list dividers-ios strong-ios inset-ios>
        <FieldListInput :name="t('email')" :label="t('email')" type="email" :placeholder="t('your-email')" :field="email"
          @input="email.value.value = $event.target.value" :outline="theme.md" clear-button />
